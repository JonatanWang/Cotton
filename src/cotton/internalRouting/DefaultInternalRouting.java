...
import ncotton.etwork.DefaultNetworkPacket;
...
public class DefaultInternalRouting implements InternalRoutingNetwork, InternalRoutingClient, InternalRoutingServiceDiscovery, InternalRoutingServiceHandler {
    ...
    private NetworkPacket prepareForTransmission(Origin origin, ServiceChain serviceChain, byte[] data,PathType pathType) {
        
        return new DefaultNetworkPacket(origin,serviceChain,pathType,data);
    }
